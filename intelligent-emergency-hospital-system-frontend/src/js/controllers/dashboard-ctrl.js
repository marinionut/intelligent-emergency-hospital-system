...
//         $http({method: 'GET', url: $rootScope.hostnameAndPort + '/api/vm/all'}).then(function (response) {
...
//         }
//
//         $http({method: 'POST', data: newVM, url: $rootScope.hostnameAndPort + /api/vm/add'}).then(function (response) {
